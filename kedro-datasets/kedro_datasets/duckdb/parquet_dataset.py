...
class CSVDataSet(AbstractVersionedDataSet[duckdb.DuckDBPyRelation, duckdb.DuckDBPyRelation]):
    """``CSVDataSet`` loads/saves data from/to a CSV file using an underlying
    filesystem (e.g.: local, S3, GCS). It uses polars to handle the CSV file.
    ...
    def _load(self) -> duckdb.DuckDBPyRelation:
        ...
        if self._protocol == "file":
            ...
            return duckdb.read_parquet(load_path, **self._load_args)
